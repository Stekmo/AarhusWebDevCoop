...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "67b7a6d4b8acc170")]
...
#pragma warning restore 0109
	...
	/// <summary>LoginArea</summary>
	[PublishedContentModel("loginArea")]
	public partial class LoginArea : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "loginArea";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public LoginArea(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<LoginArea, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
